      ...
      <section className="relative bg-[var(--wt-primary)] py-20 sm:py-28">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-blue-100 max-w-2xl mx-auto leading-relaxed">
            公共インフラの更新・耐震改修から寒冷地特有の設備工事まで、
            <br className="hidden sm:block" />
            東北・北海道エリアの施工パートナーを募集しています
          </p>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-[var(--wt-gray)] max-w-2xl mx-auto">
              東北・北海道エリアでは以下の工種で施工パートナーを募集しています
            </p>
          </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6 max-w-3xl mx-auto">
            <p className="text-[var(--wt-gray)] leading-relaxed text-base sm:text-lg">
              東北・北海道エリアでは、老朽化した公共インフラの更新・耐震改修工事の需要が高まっています。学校、病院、公共施設の防災設備強化や道路・橋梁の大規模改修プロジェクトが各地で進行しており、電気工事・管工事・建築一式工事のパートナーが求められています。公共案件の比率が高く、安定した受注が見込めるエリアです。
            </p>
            <p className="text-[var(--wt-gray)] leading-relaxed text-base sm:text-lg">
              寒冷地特有の空調・暖房設備工事や断熱改修工事のニーズが年間を通じて発生しています。冬季の凍結対策としての配管工事や、省エネルギー対応の空調設備更新、積雪対応の屋根葺き替えや凍害対策を含む防水工事など、地域の気候に精通した専門性の高い施工パートナーを求めています。
            </p>
            <p className="text-[var(--wt-gray)] leading-relaxed text-base sm:text-lg">
              仙台都市圏では商業施設やマンションの建設需要が堅調に推移しており、内装工事や電気設備工事の案件が増加しています。また、北海道では新幹線延伸に関連する大型公共工事や再開発プロジェクトが進行中で、幅広い工種での施工パートナーを必要としています。
            </p>
          </div>
        </div>
      </section>
