    ...
    <div className="min-h-screen">
      ...
      <RevealWrapper>
        ...
        <section className="relative py-24 md:py-32 bg-white overflow-hidden">
          ...
          <div className="orb orb-green absolute bottom-[-40px] left-[-60px] w-[200px] h-[200px]" aria-hidden="true" />
          {/* ドットグリッド */}
        ...
        <section className="relative py-24 md:py-32 bg-white overflow-hidden">
          ...
          <div
            data-reveal-diag
            className="absolute top-[18%] -left-[10%] w-[110%] h-[120px] bg-gradient-to-r from-[rgba(0,133,74,0.07)] via-[rgba(0,133,74,0.03)] to-transparent pointer-events-none"
            style={{ "--diag-angle": "-10deg" } as React.CSSProperties}
            aria-hidden="true"
          />
          {/* オーブ */}
