    ...
    <div className="min-h-screen">
      ...
      <section className="bg-white py-16 sm:py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200 rounded-xl p-6 sm:p-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-xl sm:text-2xl font-bold text-[var(--wt-dark)] mb-2">
                  本社拠点エリアならではの強み
                </h2>
                <p className="text-[var(--wt-gray)] leading-relaxed">
                  岡山県に本社を構えるウェルテックだからこそ、中国・四国エリアでは特に迅速な対応が可能です。現場への駆けつけ対応、急な案件依頼にも柔軟にお応えできる体制を整えています。
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-[var(--wt-gray)] max-w-2xl mx-auto">
              中国・四国エリアでは以下の工種で施工パートナーを募集しています
            </p>
          </div>
