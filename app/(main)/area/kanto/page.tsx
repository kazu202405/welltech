...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/area/kanto" },
  openGraph: {
...
const features = [
  {
    ...
    title: "案件数No.1エリア",
    description:
      "東京都を中心に、オフィスビルや商業施設の改修・リニューアル案件が年間を通じて豊富。安定した受注が見込めます。",
  },
  {
    number: "02",
    title: "住宅向け案件も充実",
    description:
      "埼玉県・千葉県・神奈川県を中心に給湯器交換やLED照明の導入工事が堅調。小規模事業者の方も参画しやすい案件を多数ご用意。",
  },
  {
    number: "03",
    title: "再開発で今後も成長",
    description:
      "東京湾岸エリアや都心部の再開発プロジェクトが多数進行中。大規模な建築一式工事から環境対応工事まで拡大中。",
  },
];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20">
              <div data-reveal>
                <SectionHeading
                  ...
                  label="Work Types"
                  title="この地域の対応工種"
                  description="関東エリアでは以下の工種で施工パートナーを募集しています"
                  align="left"
                />
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20">
              <div data-reveal>
                <SectionHeading
                  ...
                  label="Features"
                  title="この地域の特徴"
                  description="関東エリアは案件数No.1。再開発案件から住宅向け工事まで幅広く対応しています。"
                  align="left"
                />
              </div>
              <div>
