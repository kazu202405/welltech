...
/* 対応工種一覧 */
const workTypes = [
  { name: "電気工事", description: "工場・商業施設の電気設備工事" },
  { name: "建築一式工事", description: "工場・倉庫の新築・改修工事全般" },
...
/* 実績数値 */
const stats = [
  { label: "月間案件数", value: "150+", unit: "件" },
  { label: "対応工種数", value: "6", unit: "種類" },
  { label: "対応県数", value: "9", unit: "県" },
  { label: "パートナー満足度", value: "95", unit: "%" },
];
...
const features = [
  {
    ...
    title: "製造業集積地帯の安定需要",
    description:
      "日本有数の製造業集積地帯であり、自動車産業をはじめとする製造拠点の設備更新や増設に伴い、電気工事・管工事・空調設備工事の案件が安定的に発生しています。",
  },
  {
    number: "02",
    title: "名古屋都市圏の再開発",
    description:
      "名古屋都市圏では駅前再開発やオフィスビルの改修プロジェクトが活発に進行中。商業施設の内装工事やLED照明への切り替え工事など、都市型の案件も増加傾向にあります。",
  },
  {
    number: "03",
    title: "北陸新幹線延伸による需要拡大",
    description:
      "北陸新幹線の延伸に伴うインフラ整備需要が拡大。駅周辺の商業開発や宿泊施設の建設ラッシュに加え、公共施設の改修案件も増えており、今後数年間にわたって安定した需要が見込まれます。",
  },
];
  ...
  return (
    <div className="min-h-screen">
      <SubPageHero
        ...
        description="愛知県・岐阜県・三重県・静岡県・長野県・新潟県・富山県・石川県・福井県で施工パートナーを募集しています"
        breadcrumbItems={[
          { label: "ホーム", href: "/" },
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20">
              <div data-reveal>
                <SectionHeading
                  ...
                  label="Work Types"
                  title="この地域の対応工種"
                  description="中部・北陸エリアでは以下の工種で施工パートナーを募集しています"
                  align="left"
                />
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20">
              <div data-reveal>
                <SectionHeading
                  ...
                  label="Features"
                  title="この地域の特徴"
                  description="製造業の産業インフラから都市再開発まで、中部・北陸エリアは多彩な案件が揃っています。"
                  align="left"
                />
              </div>
              <div>
